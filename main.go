...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	w.Height = w.Height / CmInM
	if w.Height == 0 { //проверка ввода заведомо ложной высоты пользователя
		return 0
	}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	if s.Duration.Hours() == 0 { //проверяю деление на ноль, если время в часах укажут равным нулю
		return 0
	}
